		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Product Program(02)",
									"targetURL": "#examexprogram02-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"examexprogram02-display": {
								"semanticObject": "examexprogram02",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=exam.exprogram02",
									"url": sap.ui.require.toUrl("exam/exprogram02")
								}
							}
						}
					}
